...
% Full-width abstract (compact)
\renewcommand{\maketitlehookd}{%
	\begin{abstract}
		\noindent We demonstrate an implementation of the Variational Quantum Eigensolver using classical optical systems by encoding qubits in photonic polarization and spatial modes. Using wave plates, beam splitters, and dove prisms, we map a UCCSD-inspired VQE circuit for H$_2$ to experimentally realizable optical operations via Jones-matrix decomposition and read out energies through Stokes-parameter measurements. This optical VQE provides an accessible platform for studying variational algorithms and prototyping photonic circuit implementations.
	\end{abstract}
}
