...
\centering
\includegraphics[width=0.9\linewidth]{QWP.png}

\small QWP: $\text{QWP}(\theta)$; gate role: $R_x(\pi/2)$-type polarization rotation
\end{minipage}\hfill
\begin{minipage}[t]{0.31\textwidth}
\centering
\includegraphics[width=0.9\linewidth]{HWP.png}

\small HWP: $\text{HWP}(\phi)$; gate role: polarization rotation gate
\end{minipage}\hfill
\begin{minipage}[t]{0.31\textwidth}
\centering
\includegraphics[width=0.9\linewidth]{DP.png}

\small Dove prism: $\text{DP}(\omega)$; gate role: spatial-mode rotation gate
\end{minipage}
